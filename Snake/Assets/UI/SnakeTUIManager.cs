...
{
    /// <summary>
    /// TUI Manager for Snake — left debugger panel + right status panel.
    /// Same pattern as Breakout/Pool TUI managers.
    /// </summary>
    public class SnakeTUIManager : MonoBehaviour, ISettingsListener
    {
        ...
        private SnakeCodeDebugger _debugger;
        private RectTransform _debuggerRect;

        private SnakeStatusPanel _statusPanel;
        ...
        public void Initialize(SnakeMatchManager match, SnakeProgram program,
        ...
        {
            var canvasGO = new GameObject("SnakeTUI_Canvas");
        ...
        private void BuildPanels()
        {
            ...
            _debugger = _debuggerRect.gameObject.AddComponent<SnakeCodeDebugger>();
            ...
            _statusPanel = _statusPanelRect.gameObject.AddComponent<SnakeStatusPanel>();
